...
for(let i=0; i<faqs.length; i++){
    let flag = false;
        const plus = document.getElementsByClassName("plus")[i];
    ...
    answer.innerHTML = faqsArray[i];
    if(answer.classList.contains("animate")){
        answer.classList.remove("animate")
        answer.classList.add("animate-off")
    }
    else{
        answer.classList.remove("animate-off")
